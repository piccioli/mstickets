...
return [
     ...
     *
     * Default "chrome" (§6.4.3 del PRD, US-406): chrome-php/chrome parla col
     * Chrome DevTools Protocol in puro PHP, senza Node.js/Puppeteer — l'unica
     * dipendenza di runtime è il binario Chromium già installato in entrambe le
     * immagini Docker (docker/php/Dockerfile per lo sviluppo, docker/uat/Dockerfile
     * per produzione). "browsershot" richiederebbe invece un runtime Node.js in più,
     * mai presente nell'immagine finale UAT/produzione (solo a build-time per gli
     * asset Vite, scartato subito dopo).
     */
