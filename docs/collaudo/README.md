...
(Landing, Login, Recupero password)**, **Fase 2 (Importazione dal v1 — ETL)** e **Fase 3
(Sottosistema email)**: 333 casi di test in totale, organizzati in 71 argomenti, ciascuno tracciato
verso un test automatico realmente esistente nel repository tramite i manifest `fase-0-1.php`
(Fase 0/Fase 1), `fase-1a.php` (Fase 1A), `fase-2.php` (Fase 2) e `fase-3.php` (Fase 3).
...
- **Tester funzionale**: esegue i test manuali da interfaccia utente descritti in `02-fase-0.md`,
  `03-fase-1.md`, `04-fase-1a.md`, `05-fase-2.md` e `06-fase-3.md`.
...
| [`01-matrice-tracciabilita.md`](./01-matrice-tracciabilita.md) | Matrice che collega ogni test numerato (F0-xx/F1-xx/F1A-xx/F2-xx/F3-xx) al relativo test automatico nel repository, derivata dai manifest `fase-0-1.php`, `fase-1a.php`, `fase-2.php` e `fase-3.php`. |
...
| [`07-registro-esiti.md`](./07-registro-esiti.md) | Registro aggregato degli esiti di tutti i 333 test e delle anomalie rilevate. |
| [`08-verbale-collaudo.md`](./08-verbale-collaudo.md) | Verbale conclusivo di collaudo, con esito complessivo e firme. |
...
- **71 argomenti** in totale (l'elenco completo, con titoli letterali e conteggio test per
...
2. Eseguire i test in ordine in `02-fase-0.md`, poi in `03-fase-1.md`, poi in `04-fase-1a.md`, poi
   in `05-fase-2.md`, poi in `06-fase-3.md`, compilando per ciascun test i relativi "Campi di
   consuntivazione" (esito PASS/FAIL/BLOCKED/NOT APPLICABLE, data, tester, evidenze, eventuale
   anomalia collegata).
3. Al termine di ciascuna fase (o dell'intero ciclo), riportare l'esito aggregato di tutti i 333
   test e l'elenco delle anomalie rilevate in `07-registro-esiti.md`.
4. Chiudere il ciclo di collaudo compilando `08-verbale-collaudo.md`, con l'esito complessivo
