...
/**
 * Regola di dominio (PRD A3): la transizione verso `waiting` richiede `waiting_reason`
 ...
 */
final class TicketWaitingReasonRequiredRule implements ValidationRule
{
    public const string MESSAGE = 'Il motivo dell\'attesa è obbligatorio.';
